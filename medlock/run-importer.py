...
from medlock.app import app, import_naptan, import_network_rail_schedule, import_tfgm_schedule, activate_metrolink
...
IMPORTERS = {
    ...
    'tfgm': import_tfgm_schedule,
    'metrolink-activations': activate_metrolink
}
